App = {
  ...
  donateFunds: async ()=>{
    await App.load()
    var  a=$("#amt").val()
    var inwei=a*1000000000000000000
    //await App.sample.balance();
    await App.sample.donateFund({from:App.account,value:inwei})
  },
  displayBalance: async ()=>{
    await App.load();
    var b=await App.sample.balance();
    console.log(Number(b))
    var ineth=Number(b)/1000000000000000000
    $("#dispbal").html(ineth)
  }
